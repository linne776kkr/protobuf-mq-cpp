...
template<> ::text::TranslateRequest* Arena::CreateMaybeMessage<::text::TranslateRequest>(Arena*);
template<> ::text::TranslateResponse* Arena::CreateMaybeMessage<::text::TranslateResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace text {
...
class TranslateRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:text.TranslateRequest) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:text.TranslateRequest)
 private:
  class _Internal;
...
class TranslateResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:text.TranslateResponse) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:text.TranslateResponse)
 private:
  class _Internal;
...
inline const std::string& TranslateRequest::msg() const {
  // @@protoc_insertion_point(field_get:text.TranslateRequest.msg)
...
void TranslateRequest::set_msg(ArgT0&& arg0, ArgT... args) {
 ...
 msg_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:text.TranslateRequest.msg)
}
inline std::string* TranslateRequest::mutable_msg() {
  std::string* _s = _internal_mutable_msg();
  // @@protoc_insertion_point(field_mutable:text.TranslateRequest.msg)
  return _s;
}
...
inline std::string* TranslateRequest::release_msg() {
  // @@protoc_insertion_point(field_release:text.TranslateRequest.msg)
  return msg_.Release();
}
inline void TranslateRequest::set_allocated_msg(std::string* msg) {
  ...
  // @@protoc_insertion_point(field_set_allocated:text.TranslateRequest.msg)
}
...
inline const std::string& TranslateResponse::msg() const {
  // @@protoc_insertion_point(field_get:text.TranslateResponse.msg)
  return _internal_msg();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void TranslateResponse::set_msg(ArgT0&& arg0, ArgT... args) {
 ...
 msg_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:text.TranslateResponse.msg)
}
inline std::string* TranslateResponse::mutable_msg() {
  std::string* _s = _internal_mutable_msg();
  // @@protoc_insertion_point(field_mutable:text.TranslateResponse.msg)
  return _s;
}
...
inline std::string* TranslateResponse::release_msg() {
  // @@protoc_insertion_point(field_release:text.TranslateResponse.msg)
  return msg_.Release();
}
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:text.TranslateResponse.msg)
}
...
inline int32_t AddRequest::num1() const {
  // @@protoc_insertion_point(field_get:text.AddRequest.num1)
...
inline void AddRequest::set_num1(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:text.AddRequest.num1)
}
...
inline int32_t AddRequest::num2() const {
  // @@protoc_insertion_point(field_get:text.AddRequest.num2)
...
inline void AddRequest::set_num2(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:text.AddRequest.num2)
}
...
inline int32_t AddResponse::result() const {
  // @@protoc_insertion_point(field_get:text.AddResponse.result)
...
inline void AddResponse::set_result(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:text.AddResponse.result)
}
